...
from OpenGL.GL import (
    GL_COLOR_BUFFER_BIT, GL_DEPTH_BUFFER_BIT, GL_FRAMEBUFFER, GL_TEXTURE0,
    GL_TEXTURE1, GL_TEXTURE_2D,
    glActiveTexture, glBindFramebuffer, glBindTexture, glClear, glClearColor,
    glDisable, glGetUniformLocation, glUniform1f, glUniform1i, glUniform2f,
    glUseProgram, glViewport, GL_DEPTH_TEST, GL_BLEND,
)
...
class PostPipeline:
    ...
    def finish(self, time_s, aberration=0.0, crt=True):
        ...
        # two blur iterations (H then V), bright <-> ping
